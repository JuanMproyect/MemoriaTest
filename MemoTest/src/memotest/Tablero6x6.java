...
public class Tablero6x6 extends Tablero {
    ...
    public Tablero6x6(JPanel panelTablero, JLabel lblPuntos, JLabel lblMovimientos) {
    ...
    private char[][] generarLetras() {
        char[][] letras = new char[tamaño][tamaño];//matriz cuadrada para almacenar las letras 
        char letra = 'A';
        for (int i = 0; i < tamaño; i++) {//Llena la matriz desde 'A' en adelante
